...
public class dataEdit extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    Location mLocation;
    String serverIP,MESSAGE,SEQNO,CLSEQNO,SLNO,CITYNO,CITYNM,AREA,O_KINDSEQNO="",N_KINDSEQNO="", LAMPSTYLE,WATTS, OLDLAMPSTYLE,OLDWATTS, QTY;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("success")) {
                                ...
                                N_KINDSEQNO = detail.getString("N_KINDSEQNO");
                                ...
                                for(int i=0;i<LampAllArray.length;i++){
                                    if(N_KINDSEQNO.equals(new JSONObject(LampAllArray[i]).getString("LAMPNO"))){
                                        newType.setSelection(i+1);
                                    }
                                }
